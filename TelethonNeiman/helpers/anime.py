...
from TelethonNeiman.helpers.pasters import telegraph_paste
...
async def get_anilist(qdb, page):
    ...
    chnl = "[иღιмαив♡т](https://t.me/TeamNeiman)"
    idm = data.get("id")
    ...
    title_img = f"{idm}.jpg"
    logo = "https://te.legra.ph/file/408cb82e2a85153d56438.jpg"
    descr = ""
...
async def get_manga(qdb, page):
    ...
    finals_ += f"\n       **<\>** [иღιмαив♡т](https://t.me/TeamNeiman)"
    banner_ = requests.get(banner)
    open(f"{idm}.jpg", "wb").write(banner_.content)
    pic = f"{idm}.jpg"
    return (
