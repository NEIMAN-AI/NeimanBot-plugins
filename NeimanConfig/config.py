...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "TeamNeiman")
    MY_GROUP = os.environ.get("YOUR_GROUP", "Neiman_X_Support")
    ...
    NEIMANBOT_SESSION = os.environ.get("NEIMANBOT_SESSION", None)
    ...
    THUMB_IMG = os.environ.get("THUMB_IMG", ".")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/NEIMAN-AI/TeamNeiman")
